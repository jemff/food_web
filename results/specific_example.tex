...
We apply our method to the diel vertical migration \added{of oceanic animals} where the game is well-understood, but the interplay between the daily variations and the population dynamics have not been properly investigated. %In addition the Nash Equilibrium is known to be unique \citep{verticalmigration} at every instant.
