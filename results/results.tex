...
\todo[inline]{Måske understrege struktur v.h.a. underoverskrifter: Først adfærd, derefter emergent populationsdynamik?}
...
\end{figure}
\todo[inline]{Måske kombinere figur 2 og 3, så sammenligningen på tværs af rationalitet bliver tydeligere? Overvej tidspunkterne. Er ``dusk'' i figur 2 det samme som 18:45? i figur 3}

Examining snapshots of the migration in the ecosystem with bounded rationalty, \Cref{fig:specific_dists_irrational}, we see roughly the same picture as in \Cref{fig:specific_dists_rational}. The greatest difference is at midnight and dusk, \Cref{fig:specific_dists_irrational}(1,3), where the bounded rationality leads to a smooth shape for the distrbution of consumers. At noon, the distributions in the system with bounded rationality \Cref{fig:specific_dists_irrational}(2) and \Cref{fig:specific_dists_rational}(2) are almost entirely equal. The shapes of the distributions at both day and night seem to agree better with observations in the model with bounded rationality, \citep{visser2001observations, hay1991zooplankton}, lending credence to the idea that copepods are not perfectly rational.\todo{I nogle områder er de også udsat for turbulens, der gør det umuligt at opretholde en perfekt position.}
...
\todo[inline]{Overvej tidspunkterne. Jeg ville måske foretrække forårsjævndøgn, solhverv, og efterårsjævndøgn, så forskellen mellem det første  og det sidste tidspunkt udelukkes skyldes at abundanserne har ændret sig.}
...
\todo[inline]{Er fully irrational interessant? Det giver vel en ligefordeling, som er ret urealistisk?

Denne figur skal måske indsættes tidligere; det er svært at forstå de tidligere figurer uden denne i baghovedet.}
