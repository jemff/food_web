...
mass_vector = np.array([0.05, 20])  # np.array([1, 30, 300, 400, 800, 16000])
...
simulator_new(eco, "non_random_med", latitude = 34.5531, longitude = 18.0480)
...
simulator_new(eco, "more_random_med", latitude = 34.5531, longitude = 18.0480)
...
simulator_new(eco, "completely_random_med", optimal = False, latitude = 34.5531, longitude = 18.0480)