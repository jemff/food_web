...
simulator_new(eco, "non_random_oresund", k = 0.2, min_attack_rate=min_attack_rate, sparse = True)
...
simulator_new(eco, "more_random_oresund", k = 0.2, sparse = True, min_attack_rate=min_attack_rate)
...
simulator_new(eco, "completely_random_oresund", optimal = False, k = 0.2, min_attack_rate=min_attack_rate, sparse = True)